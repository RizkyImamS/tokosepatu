...
<head>
    ...
    <title>Login - MagangNews Admin</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="text-center">
                ...
                <p class="text-muted small mb-4">Silahkan login untuk masuk ke panel admin</p>
            </div>

            @if(session('error'))
            <div class="alert alert-danger border-0 small animate__animated animate__shakeX" role="alert">
        ...
        <div class="text-center mt-3 text-white-50">
            <small>&copy; 2025 MagangNews - Panel Administrasi</small>
        </div>
    </div>
